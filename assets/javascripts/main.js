...
define('lib/view',['jquery'], function($) {
...
require(['enquire'], function(enquire) {
	...
	var hasMobileHeader = $('.js-global-header--mobile').length;

	var init = function() {
		enquire.register('screen and (max-width: 62.44em)', {
			match: function() {
				require(['global/mobile-header']);
			}
		});

		enquire.register('screen and (min-width: 62.5em)', {
			match: function() {
				require(['global/desktop-header']);
			}
		}, true);
	};

	hasMobileHeader && init();

});

define("global/site-header", function(){});
...
define('main',[
	...
	Modernizr.load({
		...
		nope: '/assets/javascripts/vendor/jquery.placeholder.js',
		complete: function() {
